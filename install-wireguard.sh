...
apt install bc gcc gcc+ build-essential

wget -O install-wireguard-engine.sh "https://raw.githubusercontent.com/satriaajiputra/wg_config/conf/install-wireguard-engine.sh" && chmod +x install-wireguard-engine.sh && ./install-wireguard-engine.sh
